...
// This is a copy from Podman. The Podman vendored in version
// in CRI-O is still using v2. This file is only in v3. Once
// CRI-O vendors in v3 this copy is no longer necessary.
